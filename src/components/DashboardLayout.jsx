...
import { Search, Bell, Home, Workflow, BarChart3, Settings, Users, Database, ArrowRight } from "lucide-react";  // Thêm icons thiếu nếu chưa có
import { Button } from "./ui/button";  // shadcn path: ./ui/button (tùy theo setup shadcn)
...
export default function DashboardLayout({ children }) {  // Bỏ interface, dùng { children }
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside className="w-60 border-r border-gray-200 bg-white h-[calc(100vh-4rem)] ">
          <div className="p-4">
