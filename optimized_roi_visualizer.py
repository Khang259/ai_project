...
class CameraDisplayThread(threading.Thread):
    ...
    def __init__(self, camera_id: str, rtsp_url: str, local_dict: Dict,
                 ...
                 max_retry_attempts: int = 5, target_fps: float = 10.0, enable_dict: Dict[str, int] = None):
        """
        Args:
            camera_id: ID camera
            rtsp_url: RTSP URL
        ...
        self.running = False
        self.enable_dict = enable_dict if enable_dict is not None else {'value': 1}
    ...
    def run(self):
        ...
        while self.running:
            try:
                ...
                enable_state = self.enable_dict.get('value', 1)
...
class VideoDisplayManager:
    ...
    def __init__(self, show_video: bool = True, 
                 ...
                 config_path: str = "visualizer_config.json", enable_dict: Dict[str, int] = None):
