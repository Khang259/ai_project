                  ...
                  <TableBody>
                    {getFilteredAndSortedParts().length === 0 ? (
                      ...
                      getFilteredAndSortedParts().map((part, index) => {
                        const isCanThayThe = part["Cần thay thế"]
                        const isCanKiemTra = part["Cần kiểm tra"]
                        const rowHighlightClass = isCanThayThe
                        ...
                        return (
                      <TableRow key={part["Mã linh kiện"] || index} className={rowHighlightClass}>
