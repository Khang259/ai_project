...
export default function DeepAnalysisMapPanel({ robotPath = [], waitSpots = [] }) {
  ...
  return (
    <div className="w-full h-full min-h-[200px] sm:min-h-[240px] md:min-h-[280px] lg:min-h-[320px] fullhd:min-h-[360px] rounded-lg overflow-hidden flex flex-col">
      <DeepAnalysisMapCanvas mapData={mapData} robotPath={robotPath} waitSpots={waitSpots} className="flex-1 min-h-0 rounded-lg" />
    </div>
  );
}
